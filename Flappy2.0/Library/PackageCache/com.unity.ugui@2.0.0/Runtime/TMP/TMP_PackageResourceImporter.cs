...
namespace TMPro
{
    ...
    public class TMP_PackageResourceImporter
    {
        ...
        {
            m_EssentialResourcesNeedUpdate = m_ExamplesAndExtrasNeedUpdate = TMP_Settings.instance != null && TMP_Settings.instance.assetVersion != TMP_Settings.s_CurrentAssetVersion;
        }

        public void OnDestroy()
        {
            if (TMP_Settings.instance?.assetVersion != TMP_Settings.s_CurrentAssetVersion)
